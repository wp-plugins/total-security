...
<div class="inside">
<div style="float: right; margin: 0 0 10px 0"><a href="http://fabrix.net/total-security" target="_blank"><img src="<?php echo FDX_PLUGIN_URL;?>/images/logo.png" width="91" height="106" border="0" alt="" /></a></div>
<a class="sm_button sm_autor" href="http://fabrix.net/total-security" target="_blank"><?php _e('Plugin Homepage', 'fdx-lang') ?></a>
<a class="sm_button sm_code" href="http://wmais.in/?forum=total-security" target="_blank"><?php _e('Suggest a Feature', 'fdx-lang') ?></a>
<a class="sm_button sm_bug" href="http://wmais.in/?forum=total-security" target="_blank"><?php _e('Report a Bug', 'fdx-lang') ?></a>
<a class="sm_button sm_lang" href="http://translate.fabrix.net/projects/total-security/" target="_blank"><?php _e('Help Translate', 'fdx-lang') ?></a>
...
global $wp_version;
if (version_compare($wp_version, FDX_LAST_WP_VER, '>=')) { ?>
...
if (version_compare(PHP_VERSION, FDX2_MINIMUM_PHP_VER, '>=') ) { ?>
...
<div align="center"><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8DHY4NXW35T4Y" target="_blank"><img src="<?php echo FDX_PLUGIN_URL;?>/images/btn_donateCC_LG.gif" width="147" height="47" border="0" alt="" /></a></div>
<ul>
