...
<div class="postbox">
<div class="handlediv" title="<?php _e('Click to toggle', 'fdx-lang') ?>"><br /></div><h3 class='hndle'><span><?php _e('File Permissions', 'fdx-lang'); ?></span></h3>
<div class="inside">
     <br />
 ...
 echo '<table style="width:100%;" class="widefat">';
	echo '<thead><tr>';
	echo '<th style="width:25%;text-align: center">'. __('Name', 'fdx-lang') .'</th>';
    echo '<th style="width:25%;text-align: center">'. __('File/Dir', 'fdx-lang') .'</th>';
	...
	fdx_check_perms(".htaccess","../.htaccess","604");
	fdx_check_perms("wp-config.php","../wp-config.php","600");
