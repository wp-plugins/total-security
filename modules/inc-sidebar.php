...
echo '<div align="center"><a href="javascript:void(0);" onclick="PopupCenter(\'http://www.facebook.com/sharer.php?u='. $this->sbar_homepage . '&t='. $this->pluginname . ':\', \'facebook\',800,550,\'no\');" title="'. __( 'Share on', $this->hook ) .' Facebook" rel="nofollow"><img src="'. plugins_url( 'images/h3_icons/facebook.png', dirname(__FILE__)).'" width="32" height="32" border="0"  alt="*" style="margin-right: 15px" /></a>';
echo'<a href="javascript:void(0);" onclick="PopupCenter(\'https://plus.google.com/share?url='. $this->sbar_homepage . '\', \'googleplus\',800,550,\'no\');" title="'. __( 'Share on', $this->hook ) .' Google Plus" rel="nofollow"><img src="'. plugins_url( 'images/h3_icons/googleplus.png', dirname(__FILE__)).'" width="32" height="32" border="0" alt="*" style="margin-right: 15px" /></a>';
echo '<a href="javascript:void(0);" onclick="PopupCenter(\'http://twitter.com/share?text=Plugin '. $this->pluginname . ':&amp;url='. $this->sbar_homepage . '\', \'twitter\',600,450,\'no\');" title="'. __( 'Share on', $this->hook ) .' Twitter" rel="nofollow"><img src="'. plugins_url( 'images/h3_icons/twitter.png', dirname(__FILE__)).'" width="32" height="32" border="0" alt="*" style="margin-right: 15px" /></a>';
echo '<a href="javascript:void(0);" onclick="PopupCenter(\'http://api.addthis.com/oexchange/0.8/offer?title='. $this->pluginname . '&amp;url='. $this->sbar_homepage . '\', \'addthis\',550,760,\'yes\');" title="'. __( 'Share on', $this->hook ) .' Addthis" rel="nofollow"><img src="'. plugins_url( 'images/h3_icons/addthis.png', dirname(__FILE__)).'" width="32" height="32" border="0" alt="*" /></a></div>';
echo '</div></div>';
